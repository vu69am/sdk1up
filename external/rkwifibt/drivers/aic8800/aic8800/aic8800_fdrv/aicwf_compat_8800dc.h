...
#endif
#ifdef CONFIG_DPD
int aicwf_dpd_calib_8800dc(struct rwnx_hw *rwnx_hw,
			   rf_misc_ram_lite_t *dpd_res);
int aicwf_dpd_result_apply_8800dc(struct rwnx_hw *rwnx_hw,
				  rf_misc_ram_lite_t *dpd_res);
...
#endif
#ifdef CONFIG_LOFT_CALIB
int aicwf_loft_calib_8800dc(struct rwnx_hw *rwnx_hw,
			    rf_misc_ram_lite_t *loft_res);
int aicwf_loft_result_apply_8800dc(struct rwnx_hw *rwnx_hw,
				   rf_misc_ram_lite_t *loft_res);
#endif
...
int rwnx_plat_powerlimit_load_8800dcdw(struct rwnx_hw *rwnx_hw,
				       uint16_t chip_id);
#endif
